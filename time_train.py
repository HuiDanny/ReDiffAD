...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str, default='config/smd_time_train.json',
    ...
    Logger.setup_logger(None, opt['path']['log'], # type: ignore
...
python time_train.py -c config/msl_time_train.json
python time_train.py -c config/smd_time_train.json
'''
